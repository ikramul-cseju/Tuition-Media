...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <marquee style="font-size: 30px;font-weight: bold;font-family: sans-serif ; color: rgb(13, 0, 201);">To know more about this website please Log In/ Register.</marquee>
